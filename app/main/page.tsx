                  ...
                  <div className="flex gap-3 sm:gap-6" style={{ width: 'max-content', paddingLeft: '8px', paddingRight: '8px' }}>
                    {popularActivities.map((activity) => (
                      <Link
                        ...
                        className="group block flex-shrink-0 w-[131px] sm:w-[262px]"
                      >
                        <div
                          className="relative rounded-[16px] sm:rounded-[24px] overflow-hidden mb-[-30px] sm:mb-[-60px] w-full h-[145px] sm:h-[290px]"
                        >
                          <Image
                            src={activity.bannerImageUrl}
                            alt={activity.title}
                            fill
                            sizes="(max-width: 640px) 131px, 262px"
                            className="object-cover group-hover:scale-105 transition-transform duration-300"
                          />
                        </div>

                        <div
                          className="relative bg-white rounded-[12px] sm:rounded-[16px] shadow-md w-full h-[68px] sm:h-[136px] p-2 sm:p-4 flex flex-col justify-center gap-0.5 sm:gap-1"
                        >
                          <h3 
                            className="text-gray-950 line-clamp-2 text-[11px] sm:text-[18px]"
                            style={{
                              fontFamily: 'Pretendard',
                              fontWeight: 700,
                              lineHeight: '1.3',
                          ...
                          <div className="flex items-center gap-0.5 sm:gap-1">
                            ...
                            <span 
                              className="text-gray-900 text-[10px] sm:text-[14px]"
                              style={{
                                fontFamily: 'Pretendard',
                                fontWeight: 600
                              }}
                          ...
                          <p 
                            className="text-gray-950 text-[11px] sm:text-[18px]"
                            style={{
                              fontFamily: 'Pretendard',
                              fontWeight: 700,
                              lineHeight: '1.3',
                          ...
                          >
                            ...
                            <span 
                              className="text-gray-700 text-[10px] sm:text-[14px]"
                              style={{
                                fontWeight: 600
                              }}
                            >
